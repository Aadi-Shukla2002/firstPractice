    ...
    <View style={styles.main}>
      ...
      <View style={{width: dimension.width}}>
        <ScrollView
          ...
          <Image
            source={require('../theme/images/image-1.jpg')}
            style={{
              width: dimension?.width,
              height: verticalScale(200),
              resizeMode: 'cover',
      ...
      <ScrollView horizontal style={{marginBottom: 0}}>
        ...
        <View
          ...
          <Image source={require('../theme/images/Rectangle21.jpg')} />
        ...
        <View
          ...
          <Image source={require('../theme/images/Rectangle23.jpg')} />
          <View style={{backgroundColor: 'white', paddingLeft: moderateScale(5,0.1), marginRight: moderateScale(2.5,0.1)}}>
          <View
            style={{
              flexDirection: 'row',
        ...
        <View
          ...
          <Image source={require('../theme/images/1234.png') } style={{width: scale(117.5), height: verticalScale(87) }}/>
          <View style={{backgroundColor: 'white', paddingLeft: moderateScale(5,0.1), marginRight: moderateScale(2.5,0.1)}}>
      ...
      <View style={{marginLeft: moderateScale(10,0.1)}}>
        <Image source={require('../theme/images/Rectangle26.png') } style={{height: 70, width: 70,}} />
        <Image source={require('../theme/images/123.png')} style={{position: 'absolute', height:verticalScale(60), marginTop: moderateScale(5,0.1), marginLeft: moderateScale(6,0.1)}}/>
      </View>
    </View>
  );
}
